...
const mozilla::Module::ContractIDEntry kDocShellContracts[] = {
  ...
  { NS_ABOUT_MODULE_CONTRACTID_PREFIX "looppanel", &kNS_ABOUT_REDIRECTOR_MODULE_CID },
  { NS_ABOUT_MODULE_CONTRACTID_PREFIX "loopconversation", &kNS_ABOUT_REDIRECTOR_MODULE_CID },
